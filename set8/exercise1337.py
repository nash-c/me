...
def password_please() -> str:
    ...
    password = "ScooptyPoop420"
    return password


def list_please() -> list:
    """Returns a list, you can put anything in the list."""
    list = ["clipping", "chilla", "Richie Branson", "Ice Spice"]
    return list


def int_list_please() -> list:
    """Returns a list of integers, any integers are fine."""
    list_num = [5, 6, 2, 7, 72, 27, 420]
    return list_num


def string_list_please() -> list:
    """Returns a list of strings, any string are fine."""
    list_str = ["clipping", "chilla", "Richie Branson", "Ice Spice"]
    return list_str


def dictionary_please() -> dict:
    """Returns a dictionary, anything you like."""
    the_best_dictonary_ever = {"Munch":"Ice Spice", "food":"cake", "flea":"bag", "Oppenheimer":"Barbie"}
    return the_best_dictonary_ever
...
def set_it_on_fire(input_string="very naughty boy") -> str:
    ...
    """
    adele = list(input_string.upper())
    setfiretotherain = "🔥".join(adele)
    return "🔥"+ setfiretotherain + "🔥"
...
def fast_filler(number_of_words=200) -> str:
    ...
    for i in range(number_of_words):
        ...
        rando = random.choice(my_dict[length])
        words.append(rando)
